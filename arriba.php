...
//local
	echo "<input type='hidden' name='empresa1' size='20' maxlength='20' value='smobrero'/>";
...
echo "<a href='index.php?x=1'>Acerca de HistoriasWeb.1.0</a> | ";
echo date("d-m-Y H:i", time())." HistoriasWeb v. 1.0 | ";include("colores.php");
