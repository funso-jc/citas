...
{
window.open("lissocpdf.php?orden="+elorden,"parte1","top=0,left=395,status=no,toolbar=no,scrollbar=yes,location=no,type=fullWindow,fullscreen");	
}
</script>
<?php
// include("paginar.php");
...
if (!$accion) {
	echo "<div id='div1'>";
	echo "<form action='lissoc.php?accion=Listado' name='form1' method='post'>";
	echo '<fieldset><legend>Información Para Emisión de Listado de Socios</legend>';
...
if ($accion=='Listado') {
	echo "<div id='div1'>";
	echo "<form action='lissoc.php?accion=Listo' name='form1' method='post'>"; 
