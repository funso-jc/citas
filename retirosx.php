...
<?php
	...
	echo '<tr><td>Cuenta Contable</td>';
	echo '<td><input name="cdeducciones2" type="text" id="cdeducciones2" size="20" maxlength="20" value="4-02-99-01-99-01-0003" /></td>';
	echo '<td>Concepto</td>';
	echo '<td><input name="condeducciones2" type="text" id="condeducciones2" size="40" maxlength="40" value="Gastos Administrativos " /></td>';
	echo '<td>Monto</td>';
	echo '<td><input name="mdeducciones2" type="text" id="mdeducciones2" size="15" maxlength="15" value="1" /></td>';
	echo '</tr>';
