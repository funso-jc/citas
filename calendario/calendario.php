...
function mostrar_calendario($mes,$ano){
	...
	echo "<a style=color:blue;text-decoration:none href=index.php?$parametros_formulario&nuevo_mes=$mes_anterior&nuevo_ano=$ano_anterior>&lt;&lt;</a></td>";
	   echo "<td align=center class=tit>$nombre_mes $ano</td>";
	   echo "<td align=right style=font-size:10pt;font-weight:bold;color:blue>";
	...
	echo "<a style=color:blue;text-decoration:none href=index.php?$parametros_formulario&nuevo_mes=$mes_siguiente&nuevo_ano=$ano_siguiente>&gt;&gt;</a></td></tr></table></td></tr>";
	echo '	<tr>
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
function escribe_formulario_fecha_vacio($nombrecampo,$nombreformulario,$valor, $tab,$lectura){
	global $raiz;
	echo '
	<INPUT name="'.$nombrecampo.'" size="10" value ="'.$valor.'" readonly="readonly" tabindex="'.$tab.'">
	<input type=button value="..." onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')" '.$lectura.'>';	
}
?>
