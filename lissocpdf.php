...
$sql="select cod_prof, ced_prof, concat(trim(ape_prof),' ',nombr_prof) as nombre, ubic_prof, statu_prof from ".$_SESSION['bdd']."_sgcaf200 where (upper(statu_prof) <> 'RETIRA') order by ".$orden; //   limit 30"; //  limit 20";
// echo $sql;
...
$alto=3;
$salto=$alto;
$w=array(8,13,20,50,25,25); // ,25,25,25,25,25,25);
$p[0]=20;
