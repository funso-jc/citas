...
{
window.open("lisretpdf.php?orden="+elorden,"parte1","top=0,left=395,status=no,toolbar=no,scrollbar=yes,location=no,type=fullWindow,fullscreen");	
}
...
if (!$accion) {
	echo "<div id='div1'>";
	echo "<form action='lisret.php?accion=Listado' name='form1' method='post'>";
	echo '<fieldset><legend>Información Para Listado de Retiro de Socios</legend>';
?>
<script type="text/javascript">
...
onclick="return showCalendar('sel3', '%d/%m/%Y');"><br />
	Hasta:</b> <input type="text" name="date4" id="sel1" size="12" readonly
><input type="reset" value=" ... "
...
if ($accion=='Listado') {
	...
	echo "<form action='lisret.php?accion=Listo' name='form1' method='post'>"; 
