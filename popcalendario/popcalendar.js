	...
	var selectDateMessage = "Select [date] as date." // No sustituya [date], será substituido por la fecha.
...
//---------------------------------------------TRADUCCION EN ESPAÑOL-----------------------------------------------------------------------------
	...
	function constructYear() {
		//----------------------------------------FUNCION PARA DETERMINAR LOS AÑOS---------------------------------------//
		popDownMonth()
		sHTML =	""
		if (Cano <= 0) {
			var limAno = 30;}
...
//Dentro de el siguiente ciclo se generan los años, en el caso de que sea introcir fecha de nacimiento restale 30---- i>=(anoActual-30)-----
//CAMBIA el siguiente for por este " for	(i=anoActual; i<=(anoActual+4); i++) { " si quieres que los años empizen en el actual en adelante	
...
//------------------------------------TERMINAR LA FUNCION EN 0 PARA QUE INICIE EN EL DIA ACTUAL EN LA SIGUIENTE LINEA----------------------------------------------
	...
	function popUpCalendar(ctl,	ctl2, format, fi, ff, lim, cAno) {
		//LAS VARIABLES LEFTPOS Y TOPPOS SON PARA DETERMINAR EL TAMAÑO Y LA POSICIÓN DE LA VENTANA DEL CALENDARIO
