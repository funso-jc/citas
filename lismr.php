...
{
window.open("lismrpdf.php?orden="+elorden,"parte1","top=0,left=395,status=no,toolbar=no,scrollbar=yes,location=no,type=fullWindow,fullscreen");	
}
...
if (!$accion) {
	echo "<div id='div1'>";
	echo "<form action='lismr.php?accion=Listado' name='form1' method='post'>";
	echo '<fieldset><legend>Información Para Listado de Montos Retirados</legend>';
/*
...
if ($accion=='Listado') {
	...
	echo "<form action='lismr.php?accion=Listo' name='form1' method='post'>"; 
